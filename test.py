...
pygame.display.set_caption("Enemy Run")
...
def redrawGameWindow():
    ...
    sc = f.render('Score for Player 1: ' + str(score1), 1, (0, 0, 0))
    sc2 = f.render('Score for Player 2: ' + str(score2), 1, (0, 0, 0))
    ti = f.render('Time left: ' + str(timer), 4, (255, 0, 0))
    li_a = f.render('Player 1 level: ' + str(level_a), 3, (0, 0, 255))
    li_b = f.render('Player 2 level: ' + str(level_b), 3, (0, 0, 255))
...
f1 = pygame.font.SysFont('comicsans', 45, True)
timer_flag = False
count1 = 0
count2 = 0
l_inc_a = 0
...
def endscreen():
    win.blit(bg, (0, 0))
    sc = f1.render('The winner is Player 1', 1, (0, 0, 0))
    sc2 = f1.render('The winner is Player 2', 1, (0, 0, 0))
    sc3 = f1.render('It was a draw', 1, (0, 0, 0))
    if score1 > score2:
        win.blit(sc, (200, 400))
    else:
        if score2 > score1:
